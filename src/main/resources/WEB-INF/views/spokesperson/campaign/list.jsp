...
<acme:list>
	...
	<acme:list-column code="spokesperson.campaign.list.label.start-moment" path="startMoment" width="20%"/>
	<acme:list-column code="spokesperson.campaign.list.label.end-moment" path="endMoment" width="20%"/>
