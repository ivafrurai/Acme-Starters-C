...
<acme:menu-bar>
	<acme:menu-left>
		<acme:menu-option code="master.menu.any" access="isAuthenticated()">	
			...
			<acme:menu-suboption code="master.menu.any.list-sponsorships"
		...
		<acme:menu-option code="master.menu.fundraiser"
			...
			<acme:menu-suboption code="master.menu.fundraiser.list-my-strategies"
				action="/fundraiser/strategy/list" />
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.spokesperson"
			...
			<acme:menu-suboption
				...
				action="/spokesperson/campaign/list" />
		</acme:menu-option>
	</acme:menu-left>
	...
	<acme:menu-right>
		<acme:menu-option code="master.menu.user-account"
			...
			<acme:menu-suboption
				code="master.menu.user-account.become-spokesperson"
				action="/authenticated/spokesperson/create"
				access="!hasRealm('Spokesperson')" />
			<acme:menu-suboption
				code="master.menu.user-account.spokesperson-profile"
				action="/authenticated/spokesperson/update"
				access="hasRealm('Spokesperson')" />
			<acme:menu-suboption
				code="master.menu.user-account.become-fundraiser"
				action="/authenticated/fundraiser/create"
				access="!hasRealm('Fundraiser')" />
			<acme:menu-suboption
				code="master.menu.user-account.fundraiser-profile"
				action="/authenticated/fundraiser/update"
				access="hasRealm('Fundraiser')" />
			...
			<acme:menu-suboption code="master.menu.user-account.sponsor-profile"
				action="/authenticated/sponsor/update" access="hasRealm('Sponsor')" />
		</acme:menu-option>
	</acme:menu-right>
</acme:menu-bar>
